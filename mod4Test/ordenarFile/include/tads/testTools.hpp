...
// Ciudad ciudadFromString(string a){
//     Ciudad p;
//     p.idCiu=stringToInt(getTokenAt(a,',',0));// destokenizar a
//     // string t1 = getTokenAt(a,',',1);
// 	strcpy(p.descr,(getTokenAt(a,',',1)).c_str());
// 	p.millas=stringToInt(getTokenAt(a,',',2));// tokenizar a
//     return p;
// }
...
{
		FILE* f = fopen("CIUDADES2.dat","r+b");
...
int cmpCiudadDesc (Ciudad c1, Ciudad c2){
	return cmpString(c2.descr,c1.descr);
}


// int cmpIdCiudad (Ciudad c, Ciudad cod)
// {
// 	return c.idCiu-cod.idCiu;
// }
